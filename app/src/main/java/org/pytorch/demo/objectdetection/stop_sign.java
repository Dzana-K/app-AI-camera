...
public class stop_sign extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stop_sign);
                ...
                try {
                    ...
                    if (success) {
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            number.setText("You saw: " + sum+"stop signs.");


                        }

                        // Create an Intent and pass the time list and detection list to DataActivity
                        Intent intent = new Intent(stop_sign.this, DataActivity.class);
