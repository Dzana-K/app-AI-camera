...
public class traffic_light extends AppCompatActivity implements View.OnClickListener {
                ...
                try {
                    ...
                    if (success) {
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            number.setText("You saw: " + sum+"traffic lights.");


                        }

                        // Create an Intent and pass the time list and detection list to DataActivity
                        Intent intent = new Intent(traffic_light.this, DataActivity.class);
