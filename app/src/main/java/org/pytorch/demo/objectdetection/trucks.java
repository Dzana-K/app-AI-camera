...
public class trucks extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.trucks);
                ...
                try {
                    ...
                    if (success) {
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            number.setText("You saw: " + sum+"trucks.");


                        }

                        // Create an Intent and pass the time list and detection list to DataActivity
                        Intent intent = new Intent(trucks.this, DataActivity.class);
